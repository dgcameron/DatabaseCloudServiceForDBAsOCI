...
```
<copy>alter tablespace alpha_archive read only;
Tablespace altered.
```
...
```
<copy>scp -i ~/privateKey /tmp/alpha_archive_tbs.dmp opc@129.146.123.48:/tmp</copy>
...
scp -i ~/privateKey /tmp/alpha_archive.276.1031003683 opc@129.146.123.48:/tmp</copy>
...
```
<copy>scp -i ~/privateKey /tmp/source_pdb1.dmp opc@129.146.123.48:/tmp</copy>
