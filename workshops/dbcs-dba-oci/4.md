...
```
[opc@workshop1-4199 ~]$ oci compute image list -c ocid1.compartment.oc1..aaaaaaaajvin7fmiqyo7bff6rv7tk3mlnij5abr5i3ouvifvvq --output table --query "data [*].{ImageName:\"display-name\", OCID:id}"
+------------------------------------------------------------------------+----------------------------------------------------------------------------------+
| ImageName                                                              | OCID                                                                             |
+------------------------------------------------------------------------+----------------------------------------------------------------------------------+
...
```
oci db database list --compartment-id ocid1.compartment.oc1..aaaaaaaajvin7fmiqyo7bff6rv7tk3mlnij5abr5i3ouvifvvqtov --db-system-id ocid1.dbsystem.oc1.phx.abyhqljr6hza7ogkofpgzg6qvr4wl7mw5e3ctezfd57gjqzapadpf
...
```
oci network vcn list -c ocid1.compartment.oc1..aaaaaaaajvin7fmiqyo7bff6rv7tk3mlnij5abr5i3ouvifvvqt (note that -c is a shortcut for --compartment-id)
...
```
oci network vcn create -c ocid1.compartment.oc1..aaaaaaaajvin7fmiqyo7bff6rv7tk3mlnij5abr5i3ouvifvvqto --cidr-block "10.0.0.0/16"
