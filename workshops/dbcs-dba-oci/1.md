...
- Download the [oci\_ws\_alpha.dmp](./data/oci_ws_alpha.dmp) dump file and save it to a folder.  
...
```
<copy>scp -i keys/privateKey data/oci_ws_alpha.dmp opc@&lt;DBCS IP&gt;:/tmp</copy>
```
...
```
<copy>ssh -i keys/privateKey opc@&lt;DBCS IP&gt; 
...
```
<copy>cd /tmp
impdp alpha/<password> directory=tmp dumpfile=oci_ws_alpha.dmp</copy>
```
