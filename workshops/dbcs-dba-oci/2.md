...
- Lab 3:
	...
	- ***Copy tables using db links:***  Finally you copy a table in the source pdb1 database into a new table in the target `pdb2` database.  
...
-   You must have successfully completed lab 1.[^1]
[^1]:test
